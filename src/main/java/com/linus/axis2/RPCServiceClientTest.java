...
public class RPCServiceClientTest {
  ...
  // String url = "http://localhost:8080/StockQuote/services/StockQuoteServiceSOAP11port?wsdl";  
        // axis2 服务端  
        String url = "http://www.ebay.cn/maisha/sellercenter/performancetool/api/dashboard/info/demo.php";  
        ...
        //确定调用方法  
        options.setAction("urn:shipment_pre");  
        ...
        // 指定getPrice方法的参数值  
        Object[] parameters = new Object[] { "tClatUPTyDbko2TQY1QUNGtle90yHhpNJk/fAdkFIJ2Deb5BUvWq17HEyUiUn1a5TtiJLjN6mHnkiqMiSu4rIgVEMUIZBj64+hFG06+hINA="};  
        ...
        System.out.println(new String(Base64.decode(r.getBytes())));
    ...
    */  
	...
	RPCServiceClientTest.testRPCClient();  
    }  
}
