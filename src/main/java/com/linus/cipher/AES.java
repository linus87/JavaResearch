...
public class AES {
	...
	private static void test1() throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException,
	 ...
	 */
	public String encryptWithECB_PKCS5Padding(String str) throws NoSuchAlgorithmException, NoSuchPaddingException,
	 ...
	 * @throws BadPaddingException
	 */
	public String decryptWithECB_PKCS5Padding(String base64Str) throws NoSuchAlgorithmException,
	 ...
	 * @throws BadPaddingException
	 */
	public String encryptWithECB_ISO10126Padding(String str) throws NoSuchAlgorithmException, NoSuchPaddingException,
			InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
	 ...
	 * @throws BadPaddingException
	 */
	public String decryptWithECB_ISO10126Padding(String base64Str) throws NoSuchAlgorithmException,
			NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
		Cipher c = Cipher.getInstance("AES/ECB/ISO10126Padding");
		c.init(Cipher.DECRYPT_MODE, seckey);
		byte[] cipher = Base64.decodeBase64(base64Str);
